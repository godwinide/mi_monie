  ...
  try {
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          labels: ['Deposits', 'Withdraws', 'Transfers', 'Availabilty'],
          type: 'line',
          datasets: [{
            data,
            label: 'Dataset',
    ...
    // Recent Report
    const deposits = '#00b5e9'
    const withdraws = '#fa4251'
    const transfers = '#d39e00'
    const availability = '#00ad5f'
    ...
    if (ctx) {
      ...
      var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: ['Deposits', 'Withdraws', 'Transfers', 'Availability'],
          datasets: [
            {
              label: 'Deposits',
              backgroundColor: [deposits, withdraws, transfers, availability],
              borderColor: 'transparent',
