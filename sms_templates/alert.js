...
module.exports = function (account, amount, trans_type, transaction){
    const body = `Dear ${account.account_number}
your account has been${transaction.transaction_type}ed with
${amount}. Current Balance:  ${transaction.current_balance}. Available Balance:  ${transaction.available_balance}
`;
